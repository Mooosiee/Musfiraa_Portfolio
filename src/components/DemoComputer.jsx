...
const DemoComputer = (props) => {
  ...
  useEffect(() => { 
    if (txt) {
      txt.flipY = false; // Flip the video texture vertically to match the UV mapping of the model
    }
  },[txt])
  ...
  // It provides a simple and efficient way to animate HTML elements, SVGs, canvas objects, and even WebGL objects.
  //  In this code, GSAP is being used to animate the rotation of the computer model when it is loaded. The animation rotates the model from an initial position to its final position over a duration of 1 second with an easing function for smoothness.
  useGSAP(() => {
