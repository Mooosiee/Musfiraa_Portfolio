        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-headtext"> Building Through Code</p>
              <p className="grid-subtext">
                Whether it's developing projects or solving algorithmic challenges, I enjoy writing code that is both efficient and meaningful.
                My Codolio profile reflects my consistency, curiosity, and growth as a programmer.
              </p>
            </div>
            <a href="https://codolio.com/profile/musfiraa">
              <button className="btn w-full mt-16 ">
                <span>Check Out My Codolio</span>
              </button>
            </a>
          </div>
